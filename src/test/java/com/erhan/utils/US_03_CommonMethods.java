...
import com.erhan.testbase.US_02_PageInitializer;
import com.erhan.utils.US_01_Constants;

public class US_03_CommonMethods extends US_02_PageInitializer {
	...
	public static WebDriverWait getWaitObject() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(US_01_Constants.EXPLICIT_WAIT_TIME));
		return wait;
	}
	...
	public static byte[] takeScreenshot(String fileName) {
		...
		String destination = US_01_Constants.SCREENSHOT_FILEPATH + fileName + getTimeStamp() + ".png";
	...
	public static void hoverTheMouse(WebDriver driver, WebElement element)
